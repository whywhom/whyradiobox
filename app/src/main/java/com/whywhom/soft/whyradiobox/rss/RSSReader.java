...
package com.whywhom.soft.whyradiobox.rss;
...
public class RSSReader implements java.io.Closeable {
     ...
     */
    public RSSFeed load(String uri) throws RSSReaderException,RSSException {
    ...
    public RSSFeed loadPath(InputStream is, String uri) throws RSSReaderException,RSSException {
        InputStream feedStream = is;
        try {
            RSSFeed feed = parser.parse(feedStream);
